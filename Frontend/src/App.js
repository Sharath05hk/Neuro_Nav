...
function LandingPage() {
  ...
  return (
    <div className="landing-container">
      <h1 className="title">✍️ AirBoard – Drawing & Prediction</h1>
      ...
      <div className="button-row">
        <button className="action-btn">Predict Letter</button>
        <button className="action-btn">Clear Drawing</button>
        <button className="action-btn">Enable Drawing</button>
